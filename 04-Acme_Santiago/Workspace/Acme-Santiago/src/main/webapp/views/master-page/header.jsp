...
<div>
	<a href="/Acme-Santiago"><img src="images/logo.png" alt="Acme-Santiago Co., Inc." /></a>
</div>
...
<div>
	<ul id="jMenu">
		...
		<li><a href="hike/user/list.do"><spring:message code="master.page.hike.list" /></a></li>
		...
		<security:authorize access="isAnonymous()">
			...
			<li><a href="route/list.do"><spring:message code="master.page.route.search" /></a></li>
