...
<h2><spring:message code="terms.introduccion"></spring:message></h2>
<p><spring:message code="terms.introduccion.contenido"></spring:message></p>

<h2><spring:message code="terms.condiciones"></spring:message></h2>
<p><spring:message code="terms.condiciones.contenido"></spring:message></p>


<h2><spring:message code="terms.modificaciones"></spring:message></h2>
<p><spring:message code="terms.modificaciones.contenido"></spring:message></p>


<h2><spring:message code="terms.obligaciones"></spring:message></h2>
<p><spring:message code="terms.obligaciones.contenido"></spring:message></p>


<h2><spring:message code="terms.responsabilidad"></spring:message></h2>
<p><spring:message code="terms.responsabilidad.contenido"></spring:message></p>


<h2><spring:message code="terms.legislacion"></spring:message></h2>
<p><spring:message code="terms.legislacion.contenido"></spring:message></p>

<h2><spring:message code="terms.borrado"></spring:message></h2>
<p><spring:message code="terms.borrado.contenido"></spring:message></p>
