...
//	@Query("select (select count(u) from Route u where u.advertisement=0)* 1.0/count(u) from User u where u.advertisement.size!= 0)") 
//	Double dataRatioRoutedWithAvertisement();
