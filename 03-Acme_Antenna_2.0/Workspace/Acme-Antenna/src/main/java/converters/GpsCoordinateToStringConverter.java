	...
	public String convert(final GpsCoordinate gpsCoordinate) {
		...
		if (gpsCoordinate == null)
			...
			try {
				...
				builder.append(URLEncoder.encode(Double.toString(gpsCoordinate.getLatitude()), "UTF-8"));
				builder.append("|");
				builder.append(URLEncoder.encode(Double.toString(gpsCoordinate.getLongitude()), "UTF-8"));
